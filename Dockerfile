...
RUN apt-get update -qq \
	&& apt-get install -y locales libcairo2 unzip python3 python3-pip libpango1.0-dev libffi-dev \
...
RUN python3 -m pip install flask markdown jinja2 lxml cffi html5lib \
